...
func TestEstimatePopupSize_Bash(t *testing.T) {
	t.Parallel()
	w, h := server.EstimatePopupSize("Bash", `{"command":"ls -la"}`, 200, 50)
...
func TestEstimatePopupSize_Write(t *testing.T) {
	t.Parallel()
	w, h := server.EstimatePopupSize("Write", `{"file_path":"/tmp/test.txt","content":"hello world"}`, 200, 50)
...
func TestEstimatePopupSize_LongInput(t *testing.T) {
	...
	w, h := server.EstimatePopupSize("Bash", longInput, 200, 50)
...
func TestEstimatePopupSize_SmallTerminal(t *testing.T) {
	t.Parallel()
	w, h := server.EstimatePopupSize("Bash", `{"command":"ls"}`, 40, 15)
