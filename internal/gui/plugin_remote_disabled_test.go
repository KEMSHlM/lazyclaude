...
func (m *miniSessionProvider) CreateWorktreeWithOpts(_, _, _, _, _, _ string) error   { return nil }
func (m *miniSessionProvider) ResumeWorktree(_, _, _ string) error                    { return nil }
func (m *miniSessionProvider) ResumeWorktreeWithOpts(_, _, _, _, _, _ string) error   { return nil }
...
func (m *miniSessionProvider) CreatePMSessionWithOpts(_, _, _, _ string) error        { return nil }
func (m *miniSessionProvider) CreateWorkerSession(_, _, _ string) error               { return nil }
func (m *miniSessionProvider) CreateWithOpts(_, _, _, _ string) error                 { return nil }
func (m *miniSessionProvider) CreateAtPaneCWDWithOpts(_, _, _ string) error           { return nil }
