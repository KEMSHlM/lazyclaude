...
func (m *mockSessionProvider) CreateWorktreeWithOpts(_, _, _, _, _, _ string) error     { return nil }
func (m *mockSessionProvider) ResumeWorktree(_, _, _ string) error                      { return nil }
func (m *mockSessionProvider) ResumeWorktreeWithOpts(_, _, _, _, _, _ string) error     { return nil }
...
func (m *mockSessionProvider) CreatePMSessionWithOpts(_, _, _, _ string) error          { return nil }
func (m *mockSessionProvider) CreateWorkerSession(_, _, _ string) error                 { return nil }
func (m *mockSessionProvider) CreateWithOpts(_, _, _, _ string) error                   { return nil }
func (m *mockSessionProvider) CreateAtPaneCWDWithOpts(_, _, _ string) error             { return nil }
